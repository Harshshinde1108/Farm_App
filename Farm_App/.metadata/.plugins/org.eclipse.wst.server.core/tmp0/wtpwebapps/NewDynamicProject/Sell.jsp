...
<body>
	...
	<div class="container" align="center">
		<form action="StoreData" method="post">
			<div class="f-group">
				<label for="">Category </label> <select name="slct1" id="slct1"
					onchange="populate(this.id,'slct2')" required>
			...
			<div class="f-group">
				<label for="">sub category</label> <select name="slct2" id="slct2">--sub
					category--
				</select>
			</div>
			<script>
				function populate(s1, s2) {
					...
					s2.innerHTML = "";
					if (s1.value == 'fruits') {
						var optionArray = [ 'apple|Apple', 'almond|Almond',
								'apricot|Apricot', 'avocado|Avocado',
								'banana|Banana', 'berry|Berry',
								'black currant|Black Currant',
								'blackberry|Blackberry', 'blueberry|Blueberry',
								'cashew|Cashew', 'cherry|Cherry',
								'coconut|Coconut', 'cucumber|Cucumber',
								'custard apple|Custard Apple', 'dates|Dates',
								'fig|Fig', 'gooseberry|Gooseberry',
								'grapefruit|Grapefruit', 'grapes|Grapes',
								'guava|Guava', 'jackfruit|Jackfruit',
								'jujube|Jujube', 'kiwi|Kiwi', 'lemon|Lemon',
								'lychee|Lychee', 'mango|Mango',
								'mulberry|Mulberry', 'muskmelon|Muskmelon',
								'naseberry|Naseberry', 'olive|Olive',
								'orange|Orange', 'papaya|Papaya',
								'peach|Peach', 'pear|Pear',
								'persimmon|Persimmon', 'pineapple|Pineapple',
								'plum|Plum', 'pomegranate|Pomegranate',
								'prickly  pear|Prickly  Pear', 'quince|Quince',
								'raisins|Raisins', 'raspberry|Raspberry',
								'startfruit|Startfruit',
								'strawberry|Strawberry',
								'sugar cane|Sugar Cane',
								'sweet lime|Sweet Lime', 'tamarind|Tamarind',
								'walnut|Walnut',
								'water chestnut|Water Chestnut',
								'watermelon|Watermelon',
								'wood apple|Wood Apple' ];
					} else if (s1.value == 'vagitables') {
						var optionArray = [ 'bitter gourd|Bitter Gourd',
								'coriander leaf|Coriander Leaf',
								'cauliflower|Cauliflower', 'peas|Peas',
								'apple gourd|Apple Gourd', 'beetroot|Beetroot',
								'beetroot|Beetroot', 'bell pepper|Bell Pepper',
								'bitter gourd|Bitter Gourd',
								'blackpepper|Black Pepper',
								'bottle gourd|Bottle Gourd', 'brinjal|Brinjal',
								'cabbage|Cabbage', 'capsicum|Capsicum',
								'carrot|Carrot', 'cauliflower|Cauliflower',
								'chilli|Chilli', 'coriander|Coriander',
								'cucumber|Cucumber', 'drumstick|Drumstick',
								'garlic|Garlic', 'ginger|Ginger',
								'green bean|Green bean',
								'green onion|Green onion',
								'ivy gourd|Ivy gourd', 'jackfruit|Jackfruit',
								...
								'snake gourd|Snake gourd', 'spinach|Spinach',
								'sweet potato|Sweet Potato', 'tomato|Tomato',
								'zucchini|Zucchini' ];
						...
						var optionArray = [
								...
								'sorghum|Sorghum', 'soyabean|Soyabean',
						...
						var optionArray = [ 'curd|Curd', 'milk|Milk',
								'buttermilk|Buttermilk', 'ghee|Cow Ghee' ];
			...
			<div>
				...
				<sup style="color: red;">*</sup><input type="file" accept="image/*"
					name="img1" required><br> <sup style="color: red;">*</sup><input
					type="file" accept="image/*" name="img2" required><br>
				<input type="file" accept="image/*" name="img3"><br> <input
					type="file" accept="image/*" name="img4"><br> <label>Enter
					your Address:</label><sup style="color: red;">* </sup><input type="text"
					name="add" required="required">
			</div>
			<br>
			<div>
				<input type="checkbox" name="deliver" value="deliver"> <label>delivered
					to customer address</label><br> <input type="checkbox" name="take"
					value="take"> <label>take away</label><br>
			</div>
	...
	%>
	<h2>Something went wrong please try after sometime sell class not
		fount</h2>
	<%
	} catch (Exception e) {
	%>
